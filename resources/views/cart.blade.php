...
@section('content')
    <div class="container" style="margin-top: 80px">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/shop">TiendaIS</a></li>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                ...
                @foreach($cartCollection as $item)
                    <div class="row">
                        <div class="col-lg-3">
                            <img src="{{ asset('storage/' . $item->attributes->foto) }}" class="img-thumbnail" width="200" height="200">
                        ...
                        <div class="col-lg-4">
                            <div class="row">
                                ...
                                <form action="{{ route('cart.remove') }}" method="POST">
                                    {{ csrf_field() }}
                                    <input type="hidden" value="{{ $item->id }}" id="id" name="id">
                                    <button class="btn btn-dark btn-sm" style=" width: 35px; margin-top: -95px; margin-left: 115px;"><i class="fa fa-trash"></i></button>
                                </form>
                            </div>
                        </div>
                    </div>
            ...
            @if(count($cartCollection)>0)
                <div class="col-lg-5">
                    ...
                    <a href="{{ route('clientes.create') }}" class="btn btn-success">Proceder al Checkout</a>
                </div>
            @endif
        </div>
        <br><br>
